...
import { Grid, Typography, Card, CardContent } from '@mui/material';
import { categories } from '../../Helper.jsx';

const CourseCategoryItem = ({ id, imageSrc, title, courseCount }) => {
  const navigate = useNavigate();
  return (
    <Grid item xs={12} sm={6} md={4} lg={3} className="wow zoomIn" key={id} onClick={() => navigate('/login')}>
      <Card
        className="position-relative"
        sx={{
          height: '100%',
